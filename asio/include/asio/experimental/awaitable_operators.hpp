    ...
    awaitable<void, Executor> t, awaitable<void, Executor> u)
{
  ...
  auto [order, ex0, ex1] =
    co_await make_parallel_group(
      co_spawn(ex, std::move(t), asio::deferred),
      co_spawn(ex, std::move(u), asio::deferred)
    ).async_wait(
      wait_for_one_error(),
      asio::deferred
    );
    ...
    awaitable<void, Executor> t, awaitable<U, Executor> u)
{
  ...
  auto [order, ex0, ex1, r1] =
    co_await make_parallel_group(
      co_spawn(ex, std::move(t), asio::deferred),
      co_spawn(ex, detail::awaitable_wrap(std::move(u)), asio::deferred)
    ).async_wait(
      wait_for_one_error(),
      asio::deferred
    );
    ...
    awaitable<T, Executor> t, awaitable<void, Executor> u)
{
  ...
  auto [order, ex0, r0, ex1] =
    co_await make_parallel_group(
      co_spawn(ex, detail::awaitable_wrap(std::move(t)), asio::deferred),
      co_spawn(ex, std::move(u), asio::deferred)
    ).async_wait(
      wait_for_one_error(),
      asio::deferred
