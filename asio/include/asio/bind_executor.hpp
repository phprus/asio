...
[[nodiscard]] inline executor_binder<typename decay<T>::type, Executor>
...
[[nodiscard]] inline executor_binder<typename decay<T>::type,
...
struct associator<Associator, executor_binder<T, Executor>, DefaultCandidate>
{
  ...
  static type get(const executor_binder<T, Executor>& b) noexcept(true)
  {
