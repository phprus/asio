...
// Helper macros for working with std source locations.
...
#else // if defined(ASIO_HAS_SOURCE_LOCATION) && defined(ASIO_HAS_STD_SOURCE_LOCATION)
# define ASIO_SOURCE_LOCATION_PARAM
# define ASIO_SOURCE_LOCATION_DEFAULTED_PARAM
# define ASIO_SOURCE_LOCATION_ARG
#endif // if defined(ASIO_HAS_SOURCE_LOCATION) && defined(ASIO_HAS_STD_SOURCE_LOCATION)
