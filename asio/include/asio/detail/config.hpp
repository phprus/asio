...
// C++17: Support move construction and assignment on compilers known to allow it.
...
// C++17: Support variadic templates on compilers known to allow it.
#define ASIO_HAS_VARIADIC_TEMPLATES 1

// C++17: Support constexpr on compilers known to allow it.
...
// C++17: Support noexcept on compilers known to allow it.
...
// C++17: Support return type deduction on compilers known to allow it.
#define ASIO_HAS_RETURN_TYPE_DEDUCTION 1

// C++17: Support default function template arguments on compilers known to allow it.
#define ASIO_HAS_DEFAULT_FUNCTION_TEMPLATE_ARGUMENTS 1

// C++17: Support enum classes on compilers known to allow them.
...
// C++17: Support template variables on compilers known to allow it.
...
// C++17: Standard library support for std::align.
#define ASIO_HAS_STD_ALIGN 1

// C++17: Standard library support for system errors.
#define ASIO_HAS_STD_SYSTEM_ERROR 1

// C++17: Standard library support for arrays.
#define ASIO_HAS_STD_ARRAY 1

// C++17: Standard library support for shared_ptr and weak_ptr.
#define ASIO_HAS_STD_SHARED_PTR 1

// C++17: Standard library support for allocator_arg_t.
#define ASIO_HAS_STD_ALLOCATOR_ARG 1

// C++17: Standard library support for atomic operations.
#define ASIO_HAS_STD_ATOMIC 1

// C++17: Standard library support for chrono.
...
// C++17: Standard library support for the function class.
#define ASIO_HAS_STD_FUNCTION 1

// C++17: Standard library support for the reference_wrapper class.
#define ASIO_HAS_STD_REFERENCE_WRAPPER 1

// C++17: Standard library support for type traits.
#define ASIO_HAS_STD_TYPE_TRAITS 1

// C++17: Standard library support for the std::nullptr_t type.
#define ASIO_HAS_NULLPTR 1

// C++17: Standard library support for the C++11 allocator additions.
#define ASIO_HAS_CXX11_ALLOCATORS 1

// C++17: Standard library support for the cstdint header.
...
// C++17: Standard library support for the call_once function.
#define ASIO_HAS_STD_CALL_ONCE 1

// C++17: Standard library support for futures.
#define ASIO_HAS_STD_FUTURE 1

// C++17: Standard library support for std::tuple.
#define ASIO_HAS_STD_TUPLE 1

// C++17: Standard library support for std::string_view.
#define ASIO_HAS_STD_STRING_VIEW 1
#define ASIO_HAS_STRING_VIEW 1

// C++17: Standard library support for iostream move construction and assignment.
...
// C++17: Standard library support for std::nested_exception.
#define ASIO_HAS_STD_NESTED_EXCEPTION 1

// C++17: Standard library support for std::any.
...
// C++17: Standard library support for std::index_sequence.
...
// C++17: Standard library support for std::hash.
