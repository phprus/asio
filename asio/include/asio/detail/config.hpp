...
// C++20: Support move construction and assignment on compilers known to allow it.
...
// C++20: Support constexpr on compilers known to allow it.
...
// C++20: Support noexcept on compilers known to allow it.
#define ASIO_HAS_NOEXCEPT 1

// C++20: Support noexcept on function types on compilers known to allow it.
#define ASIO_HAS_NOEXCEPT_FUNCTION_TYPE 1

// C++20: Support automatic type deduction on compilers known to support it.
...
// C++20: Support enum classes on compilers known to allow them.
#define ASIO_HAS_ENUM_CLASS 1

// C++20: Support concepts on compilers known to allow them.
#define ASIO_HAS_CONCEPTS 1

// C++20: Support concepts on compilers known to allow them.
#define ASIO_HAS_STD_CONCEPTS 1

// C++20: Support template variables on compilers known to allow it.
#define ASIO_HAS_VARIABLE_TEMPLATES 1

// C++20: Support SFINAEd template variables on compilers known to allow it.
...
// C++20: Support for capturing parameter packs in lambdas.
...
// C++20: Standard library support for shared_ptr and weak_ptr.
#define ASIO_HAS_STD_SHARED_PTR 1

// C++20: Standard library support for allocator_arg_t.
#define ASIO_HAS_STD_ALLOCATOR_ARG 1

// C++20: Standard library support for atomic operations.
#define ASIO_HAS_STD_ATOMIC 1

// C++20: Standard library support for chrono.
#define ASIO_HAS_STD_CHRONO 1
#define ASIO_HAS_CHRONO 1

// C++20: Standard library support for addressof.
#define ASIO_HAS_STD_ADDRESSOF 1

// C++20: Standard library support for the function class.
#define ASIO_HAS_STD_FUNCTION 1

// C++20: Standard library support for the reference_wrapper class.
#define ASIO_HAS_STD_REFERENCE_WRAPPER 1

// C++20: Standard library support for type traits.
#define ASIO_HAS_STD_TYPE_TRAITS 1

// C++20: Standard library support for the std::nullptr_t type.
#define ASIO_HAS_NULLPTR 1

// C++20: Standard library support for the C++11 allocator additions.
#define ASIO_HAS_CXX11_ALLOCATORS 1

// C++20: Standard library support for the cstdint header.
#define ASIO_HAS_CSTDINT 1

// C++20: Standard library support for the thread class.
#define ASIO_HAS_STD_THREAD 1

// C++20: Standard library support for the mutex and condition variable classes.
#define ASIO_HAS_STD_MUTEX_AND_CONDVAR 1

// C++20: Standard library support for the call_once function.
#define ASIO_HAS_STD_CALL_ONCE 1

// C++20: Standard library support for futures.
#define ASIO_HAS_STD_FUTURE 1

// C++20: Standard library support for std::tuple.
#define ASIO_HAS_STD_TUPLE 1

// C++20: Standard library support for std::string_view.
...
// C++20: Standard library support for std::exception_ptr and std::current_exception.
#define ASIO_HAS_STD_EXCEPTION_PTR 1

// C++20: Standard library support for std::nested_exception.
#define ASIO_HAS_STD_NESTED_EXCEPTION 1

// C++20: Standard library support for std::any.
...
// C++20: Support the co_await keyword on compilers known to allow it.
#define ASIO_HAS_CO_AWAIT 1

// C++20: Standard library support for coroutines.
...
// C++20: Standard library support for std::hash.
#define ASIO_HAS_STD_HASH 1

// C++20: Standard library support for std::to_address.
