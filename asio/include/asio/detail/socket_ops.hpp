...
ASIO_DECL socket_type sync_accept(socket_type s, state_type state,
    void* addr, std::size_t* addrlen, std::error_code& ec);
...
ASIO_DECL bool sockatmark(socket_type s, std::error_code& ec);

ASIO_DECL size_t available(socket_type s, std::error_code& ec);
...
ASIO_DECL signed_size_type recv1(socket_type s,
    void* data, size_t size, int flags, std::error_code& ec);
...
ASIO_DECL signed_size_type send1(socket_type s,
    const void* data, size_t size, int flags, std::error_code& ec);
...
ASIO_DECL std::error_code getaddrinfo(const char* host,
    const char* service, const addrinfo_type& hints,
    addrinfo_type** result, std::error_code& ec);

ASIO_DECL std::error_code background_getaddrinfo(
...
ASIO_DECL std::error_code getnameinfo(const void* addr,
    std::size_t addrlen, char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int flags, std::error_code& ec);

ASIO_DECL std::error_code sync_getnameinfo(const void* addr,
    std::size_t addrlen, char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, std::error_code& ec);

ASIO_DECL std::error_code background_getnameinfo(
    const weak_cancel_token_type& cancel_token,
