...
{
public:
  io_uring_socket_accept_op_base(const std::error_code& success_ec,
...
public:
  ...
  io_uring_socket_accept_op(const std::error_code& success_ec,
      socket_type socket, socket_ops::state_type state, Socket& peer,
      const Protocol& protocol, typename Protocol::endpoint* peer_endpoint,
...
public:
  ...
  io_uring_socket_move_accept_op(const std::error_code& success_ec,
