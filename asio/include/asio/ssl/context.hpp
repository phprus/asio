...
public:
   ...
   * @note Calls @c SSL_CTX_set_verify.
   */
  ASIO_DECL void set_verify_mode(
   ...
   * @note Calls @c SSL_CTX_set_verify_depth.
   */
  ASIO_DECL void set_verify_depth(
   ...
   * @note Calls @c SSL_CTX_load_verify_locations.
   */
  ASIO_DECL void load_verify_file(
   ...
   * @note Calls @c SSL_CTX_get_cert_store and @c X509_STORE_add_cert.
   */
  ASIO_DECL void add_certificate_authority(
   ...
   * @note Calls @c SSL_CTX_load_verify_locations.
   */
  ASIO_DECL void add_verify_path(
   ...
   * @note Calls @c SSL_CTX_use_certificate_chain_file.
   */
  ASIO_DECL void use_certificate_chain_file(
      const std::string& filename, std::error_code& ec);
   ...
   * @note Calls @c SSL_CTX_set_tmp_dh.
   */
  ASIO_DECL void use_tmp_dh_file(
      const std::string& filename, std::error_code& ec);
...
private:
  ...
  ASIO_DECL void do_set_verify_callback(
  ...
  ASIO_DECL void do_set_password_callback(
  ...
  ASIO_DECL static std::error_code translate_error(long error);
